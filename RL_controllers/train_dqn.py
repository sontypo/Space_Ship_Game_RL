...
from utils import stack_frames, log_metrics, save_model, create_directory, PrioritizedReplayMemory

# usage: python3 train_dqn_normal_buffer.py --max_episodes 5000 --save_path d3qn_prioritized_buffer_data
def train_dqn():
    parser = argparse.ArgumentParser()
    parser.add_argument('--max_episodes', type=int, default='4000', help="Set maximum number of episodes for training.")
    parser.add_argument('--save_path', type=str, default='d3qn_prioritized_buffer_data', help='Loading save path.')
    ...
    learning_rate = 1e-4
    use_prioritized_replay = True  # Set to True to use Prioritized Replay Memory
    ...
    for episode in range(max_episodes):
        ...
        print(f"Episode: {episode+1}, Total Reward: {total_reward}, Score: {current_score}, Health: {current_health}, Memory Size: {len(agent.replay_buffer.memory)}")
